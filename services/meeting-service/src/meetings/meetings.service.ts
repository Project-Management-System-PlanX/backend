...
import { meetings, MeetingStatus } from '@prisma/client';
...
// Update all participants who haven't left yet
   ...
   */
  async getActiveMeetings(groupId?: string): Promise<any[]> {
    const where: any = { status: 'ACTIVE' as MeetingStatus };
   ...
   */
  async getMeetingHistory(userId: string): Promise<any[]> {
